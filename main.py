...
if os.path.exists(file_path):
    try:
        ...
        if 'nama_laptop' in laptop_df.columns:
            laptop_df['desc_clean'] = laptop_df['nama_laptop'].apply(clean_text)

            # Menghitung TF-IDF dan Cosine Similarity
            laptop_df.set_index('nama_laptop', inplace=True)
            ...
            st.error("Kolom 'nama_laptop' tidak ditemukan dalam dataset.")
